...
// ListNotesRequest uses offset pagination (training default).
// Prefer keyset pagination if note volume grows.
...
const file_api_notes_v1_note_service_proto_rawDesc = "" +
	...
	"\fNoteResponse\x12\"\n" +
	"\x04note\x18\x01 \x01(\v2\x0e.notes.v1.NoteR\x04note2\x8f\x04\n" +
	"\vNoteService\x12[\n" +
	"\n" +
	...
	"\tListNotes\x12\x1a.notes.v1.ListNotesRequest\x1a\x1b.notes.v1.ListNotesResponse\"\x15\x82\xd3\xe4\x93\x02\x0f\x12\r/api/v1/notes\x12\x83\x01\n" +
	"\n" +
	"UpdateNote\x12\x1b.notes.v1.UpdateNoteRequest\x1a\x16.notes.v1.NoteResponse\"@\x82\xd3\xe4\x93\x02::\x01*Z\x1c:\x01*\x1a\x17/api/v1/notes/{note_id}2\x17/api/v1/notes/{note_id}\x12b\n" +
	"\n" +
