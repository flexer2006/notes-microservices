...
// RegisterResponse mirrors LoginResponse so clients share one token DTO.
...
func (x *RefreshTokensResponse) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
const file_api_auth_v1_auth_service_proto_rawDesc = "" +
	...
	"\rrefresh_token\x18\x01 \x01(\tR\frefreshToken\"\xcf\x01\n" +
	"\x15RefreshTokensResponse\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\x12!\n" +
	"\faccess_token\x18\x03 \x01(\tR\vaccessToken\x12#\n" +
	"\rrefresh_token\x18\x04 \x01(\tR\frefreshToken\x129\n" +
