...
//
// AuthService issues and rotates JWT access/refresh pairs.
// HTTP annotations document the public REST shape; the Fiber gateway is the
// live edge, while grpc-gateway stubs remain available for tooling.
